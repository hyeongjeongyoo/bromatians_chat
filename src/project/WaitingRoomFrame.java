...
public class WaitingRoomFrame extends JFrame {
	...
	public void setInitData() {
		...
		add(roomsscroll);
		roomsscroll.setBorder(new LineBorder(Color.BLACK, 3));
		roomsscroll.setBounds(15, 405, 360, 170);
		friendsList.setFont(font);
		//roomsPanel.setBackground(Color.WHITE);

//		roomsPanel.add(roomsscroll);
//		roomsscroll.setBounds(0, 0, 350, 155);
	...
	public void addEventListener() {
		...
		goRoom.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				System.out.println("방 입장 아이콘 클릭");
				mContext.getWaitingRoonFrame().setVisible(false);
				ChatFrame chatFrame = new ChatFrame(mContext);
//				mContext.setChatFrame(chatFrame);
//				chatFrame.setVisible(true);
//				mContext.addRoomList();
			}
		});
	}
